...
export const getStaticProps: GetStaticProps = async () => {
  ...
  //         totalLiquidityUSD
  //       }
  //       token(id: "0xe3b42852a85d38b18076ab2dd96b0f894cc0636c") {
  //         derivedUSD
  //       }
  //     }
  //   `)
  //   const { totalLiquidityUSD } = result.pancakeFactories[0]
  //   results.tvl = parseFloat('0') * result.token.derivedUSD + parseFloat(totalLiquidityUSD)
  // } catch (error) {
  //   if (process.env.NODE_ENV === 'production') {
