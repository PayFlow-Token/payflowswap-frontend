...
import { ConnectorNames, connectorLocalStorageKey, Text, Box, LinkExternal } from '@payflowswap/uikit'
            ...
            if (error instanceof NoEthereumProviderError || error instanceof NoBscProviderError) {
              toastError(
                ...
                <Box>
                  ...
                  <LinkExternal href="https://docs.payflowtoken.com">{t('Need help ?')}</LinkExternal>
                </Box>,
              )
            } else if (
